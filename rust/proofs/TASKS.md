...
- Completion: 56%
- Done: task map defined, implementation batch merged, printable-reference workflow added, concrete Verus reducer/workspace proof modules added, and proof CI gates wired.
