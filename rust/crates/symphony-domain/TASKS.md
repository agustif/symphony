...
- [ ] Subtask D1.2.1: Define invariant and transition errors.
...
- [ ] Subtask D2.1.1: Claim/dispatch/start transitions.
- [ ] Subtask D2.1.2: Completion/failure transitions.

### Task D2.2: Retry/reconcile transitions
- [ ] Subtask D2.2.1: Retry scheduling and cancellation transitions.
- [ ] Subtask D2.2.2: Terminal/non-active reconcile transitions.

## Epic D3: Invariants and Tests
### Task D3.1: Invariant API
- [ ] Subtask D3.1.1: Expose invariant validation helpers.
- [ ] Subtask D3.1.2: Include structured violation diagnostics.

### Task D3.2: Test depth
- [ ] Subtask D3.2.1: Unit tests for every transition.
