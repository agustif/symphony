...
- [ ] Subtask L3.1.2: Verify strict required field handling.

### Task L3.2: Adapter tests
- [ ] Subtask L3.2.1: Mock server query/response tests.
- [ ] Subtask L3.2.2: Error-path coverage tests.
